...
return output.join("").substr(0,i)};VMasker.toNumber=function(value){return value.toString().replace(/(?!^-)[^0-9]/g,"")};VMasker.toAlphaNumeric=function(value){return value.toString().replace(/[^a-z0-9 ]+/i,"")};return VMasker}));const urlName='app-sao-roque-e-voce/back-end';const urlCadastro=urlName+'/cadastro';const urlLogin=urlName+'/srv/login';const urlRedefinePassword=urlName+'/srv/redefinir_senha';const urlNewPassword=urlName+'/srv/nova_senha';const urlLoginRacs=urlName+'/racs/login';const urlContatoRacs=urlName+'/contato';function getRoot(url){var root="http://"+document.location.hostname+"/"+url;return root}
const gif=getRoot(urlName+'/img/anime.gif');const logoSrv=getRoot(urlName+'/img/logo-srv-200.png');const logoRacs=getRoot(urlName+'/img/logo-racs-100.png');const CarregandoLoading=()=>document.getElementById('root').innerHTML=`<img  class="gif" src='${gif}' alt="Logomarca da WEF">`;const ParandoLoading=()=>document.getElementById('root').innerHTML=`<img  src='${logoSrv}' alt="Logomarca da ">`;const LoadingRacs=()=>document.getElementById('root').innerHTML=`<img  class="gif" src='${gif}' alt= Loading">`;const ParandoLoadingRacs=()=>document.getElementById('root').innerHTML=`<img  src='${logoRacs}' alt="Logomarca da RACS" style="width: 70px;">`;$('#cpf , #birthDate, #phone').on('focus',function(){var id=$(this).attr("id");if(id=="cpf"){VMasker(document.querySelector("#cpf")).maskPattern("999.999.999-99")}
if(id=="birthDate"){VMasker(document.querySelector("#birthDate")).maskPattern("99/99/9999")}
if(id=="phone"){VMasker(document.querySelector("#phone")).maskPattern("(99)-999999999")}});function getCaptcha(){grecaptcha.ready(function(){grecaptcha.execute(sitekey,{action:'homepage'}).then(function(token){const gRecaptchaResponse=document.querySelector("#g-recaptcha-response").value=token})})}
getCaptcha();$("#formCadastro").on("submit",function(event){event.preventDefault();CarregandoLoading();var dados=$(this).serialize();$.ajax({url:getRoot(urlCadastro),type:'post',dataType:'json',data:dados,success:function(response){$('.retornoCad').empty();if(response.retorno=='erro'){getCaptcha();$.each(response.erros,function(key,value){M.toast({html:`<span class="lighten-2">${value}</span><button class="btn-flat toast-action"><i class="material-icons yellow-text">error_outline</i></button>`,classes:'rounded',inDuration:5000,outDuration:5000,})})}else{$.each(response.success,function(key,value){M.toast({html:`<span>${value}</span><button class="btn-flat toast-action"><i class="material-icons green-text">thumb_up</i></button>`,classes:'rounded',inDuration:5000,outDuration:5000,})});setTimeout(()=>{window.location.href=response.page},6000)}
ParandoLoading()}})});$("#senha").keypress(function(e){kc=e.keyCode?e.keyCode:e.which;sk=e.shiftKey?e.shiftKey:((kc==16)?true:!1);if(((kc>=65&&kc<=90)&&!sk)||(kc>=97&&kc<=122)&&sk){$(".resultadoForm").html("Caps Lock Ligado")}else{$(".resultadoForm").empty()}});$("#formRedefinePassword").on("submit",function(event){event.preventDefault();CarregandoLoading();var dados=$(this).serialize();$.ajax({url:getRoot(urlRedefinePassword),type:'post',dataType:'json',data:dados,success:function(response){if(response.retorno=='success'){$.each(response.success,function(key,value){M.toast({html:`<span>${value}</span><button class="btn-flat toast-action"><i class="material-icons green-text">thumb_up</i></button>`,classes:'rounded',inDuration:5000,outDuration:5000,})});setTimeout(()=>{window.location.href=response.page},6000)}else{getCaptcha();if(response.tentativas==!0){}
$('.resultadoForm').empty();$.each(response.erros,function(key,value){$('.resultadoForm').append(value+'<br>')})}
ParandoLoading()}})});$("#formNewPassword").on("submit",function(event){event.preventDefault();CarregandoLoading();var dados=$(this).serialize();$.ajax({url:getRoot(urlNewPassword),type:'post',dataType:'json',data:dados,success:function(response){if(response.retorno=='success'){$.each(response.success,function(key,value){M.toast({html:`<span>${value}</span><button class="btn-flat toast-action">
                <i class="material-icons green-text">thumb_up</i></button>`,classes:'rounded',inDuration:5000,outDuration:5000,})});setTimeout(()=>{window.location.href=response.page},6000)}else{getCaptcha();if(response.tentativas==!0){}
$('.resultadoForm').empty();$.each(response.erros,function(key,value){$('.resultadoForm').append(value+'<br>')})}
ParandoLoading()}})});$("#formLogin").on("submit",function(event){CarregandoLoading();event.preventDefault();var dados=$(this).serialize();$.ajax({url:getRoot(urlLogin),type:'post',dataType:'json',data:dados,success:function(response){if(response.retorno=='success'){window.location.href=response.page}else{getCaptcha();if(response.tentativas==!0){}
$('.resultadoForm').empty();$.each(response.erros,function(key,value){$('.resultadoForm').append(value+'<br>')})}
ParandoLoading()}})});$("#formLoginRacs").on("submit",function(event){CarregandoLoading();event.preventDefault();var dados=$(this).serialize();$.ajax({url:getRoot(urlLoginRacs),type:'post',dataType:'json',data:dados,success:function(response){if(response.retorno=='success'){window.location.href=response.page}else{getCaptcha();if(response.tentativas==!0){}
$('.resultadoForm').empty();$.each(response.erros,function(key,value){$('.resultadoForm').append(value+'<br>')})}
ParandoLoadingRacs()}})});$("#formContato").on("submit",function(event){event.preventDefault();LoadingRacs();var dados=$(this).serialize();$.ajax({url:getRoot(urlContatoRacs),type:'post',dataType:'json',data:dados,success:function(response){if(response.retorno=='erro'){getCaptcha();$.each(response.erros,function(key,value){M.toast({html:`<span class="lighten-2">${value}</span><button class="btn-flat toast-action"><i class="material-icons yellow-text">error_outline</i></button>`,classes:'rounded',inDuration:5000,outDuration:5000,})})}else{$.each(response.success,function(key,value){M.toast({html:`<span>${value}</span><button class="btn-flat toast-action"><i class="material-icons green-text">thumb_up</i></button>`,classes:'rounded',inDuration:5000,outDuration:5000,})})}
ParandoLoading()}})});const UrlSrvConfigCep=urlName+'/srv/configuracao/cep';const UrlSrvConfigTipo=urlName+'/srv/configuracao/tipo';const UrlSrvConfig=urlName+'/srv/configuracao';const UrlSrvDetalhes=urlName+'/srv/detalhes';const UrlSrvTela=urlName+'/srv/tela';const LoadingCep=()=>document.getElementById('loadingCep').innerHTML='<div class="preloader-wrapper small active"><div class="spinner-layer spinner-green-only"><div class="circle-clipper left"><div class="circle"></div></div><div class="gap-patch"><div class="circle"></div></div><div class="circle-clipper right"><div class="circle"></div></div></div></div>';const ParandoLoadingCep=()=>document.getElementById('loadingCep').innerHTML='';const LoadingConfig=()=>document.getElementById('loading').innerHTML='<div class="preloader-wrapper small active"><div class="spinner-layer spinner-green-only"><div class="circle-clipper left"><div class="circle"></div></div><div class="gap-patch"><div class="circle"></div></div><div class="circle-clipper right"><div class="circle"></div></div></div></div>';const BreakLoadingConfig=()=>document.getElementById('loading').innerHTML='';$(document).ready(function(){$('.modal').modal()});$('#cep, #telefone, #celular').on('focus',function(){var id=$(this).attr("id");if(id=="cep"){VMasker(document.querySelector("#cep")).maskPattern("99999-999")}
if(id=="telefone"){VMasker(document.querySelector("#telefone")).maskPattern("(99)9999-9999")}
if(id=="celular"){VMasker(document.querySelector("#celular")).maskPattern("(99)99999-9999")}});const inputsAddresSrv=(result)=>{for(const campo in result){if(document.querySelector("#"+campo)){document.querySelector("#"+campo).value=result[campo]}}};const clearInputsAddresSrv=()=>{document.querySelector("#cep").value='';document.querySelector("#logradouro").value='';document.querySelector("#bairro").value='';document.querySelector("#localidade").value=''};$('#segmento').on('change',function(event){if((document.querySelector("#segmento").value.length>1)||document.querySelector("#segmento").value!='{{segmento}}'){let tipo=document.querySelector("#segmento").value;if(tipo=='servicos'){document.getElementById("divDiversos").style.display="block";document.getElementById("divServicos").style.display="none"}else{document.getElementById("divDiversos").style.display="none";document.getElementById("divServicos").style.display="block"}}});$('#cep').on('blur',function(event){if(document.querySelector("#cep").value.length==9){event.preventDefault();LoadingCep();var dados=$(this).serialize();$.ajax({url:getRoot(UrlSrvConfigCep),type:'post',dataType:'json',data:dados,success:function(response){if(response.retorno=='success'){inputsAddresSrv(response.inputs);ParandoLoadingCep()}else{M.toast({html:`<span class="lighten-2">${response.erros}</span><button class="btn-flat toast-action"><i class="material-icons yellow-text">error_outline</i></button>`,classes:'rounded',inDuration:5000,outDuration:5000,});clearInputsAddresSrv();ParandoLoadingCep()}}})}});$("#formConfig").on("submit",function(event){event.preventDefault();LoadingConfig();var dados=$(this).serialize();$.ajax({url:getRoot(UrlSrvConfig),type:'post',dataType:'json',data:dados,success:function(response){$('.loading').empty();if(response.retorno=='erro'){getCaptcha();$.each(response.erros,function(key,value){M.toast({html:`<span class="lighten-2">${value}</span><button class="btn-flat toast-action"><i class="material-icons yellow-text">error_outline</i></button>`,classes:'rounded, red',inDuration:5000,outDuration:5000,})})}else{$.each(response.success,function(key,value){getCaptcha();M.toast({html:`<span>${value}</span><button class="btn-flat toast-action"><i class="material-icons blue-text">thumb_up</i></button>`,classes:'rounded, green',inDuration:5000,outDuration:5000,})});setTimeout(()=>{window.location.href=response.page},3000)}
BreaKLoadingConfig()}})});$('#semana, #sabado, #domingo, #feriado').on('focus',function(){var id=$(this).attr("id");if(id=="semana"){VMasker(document.querySelector("#semana")).maskPattern("99:99 - 99:99")}
...
if(id=="feriado"){VMasker(document.querySelector("#feriado")).maskPattern("99:99 - 99:99")}});$("#formDetahes").on("submit",function(event){event.preventDefault();LoadingConfig();var dados=$(this).serialize();$.ajax({url:getRoot(UrlSrvDetalhes),type:'post',dataType:'json',data:dados,success:function(response){$('.loading').empty();if(response.retorno=='erro'){getCaptcha();$.each(response.erros,function(key,value){M.toast({html:`<span class="lighten-2">${value}</span><button class="btn-flat toast-action"><i class="material-icons yellow-text">error_outline</i></button>`,classes:'rounded, red',inDuration:5000,outDuration:5000,})})}else{$.each(response.success,function(key,value){getCaptcha();M.toast({html:`<span>${value}</span><button class="btn-flat toast-action"><i class="material-icons blue-text">thumb_up</i></button>`,classes:'rounded, green',inDuration:5000,outDuration:5000,})});setTimeout(()=>{window.location.href=response.page},6000)}
BreakLoadingConfig()}})});$("#formImagens").on("submit",function(event){event.preventDefault();var form_img=new FormData(document.getElementById("formImagens"));LoadingConfig();$.ajax({url:getRoot(UrlSrvTela),method:'post',data:form_img,dataType:'json',cache:!1,contentType:!1,processData:!1,success:function(response){$('.loading').empty();if(response.retorno=='erro'){getCaptcha();$.each(response.erros,function(key,value){M.toast({html:`<span class="lighten-2">${value}</span><button class="btn-flat toast-action"><i class="material-icons yellow-text">error_outline</i></button>`,classes:'rounded, red',inDuration:5000,outDuration:5000,})})}else{$.each(response.success,function(key,value){getCaptcha();M.toast({html:`<span>${value}</span><button class="btn-flat toast-action"><i class="material-icons blue-text">thumb_up</i></button>`,classes:'rounded, green',inDuration:5000,outDuration:5000,})});setTimeout(()=>{window.location.href=response.page},10000)}
BreakLoadingConfig()}})});$(function(){$('#slide img:eq(0)').addClass("ativo").show();setInterval(slide,5000);function slide(){if($('.ativo').next().length){$('.ativo').fadeOut().removeClass("ativo").next().fadeIn().addClass("ativo")}else{$('.ativo').fadeOut().removeClass("ativo");$('#slide img:eq(0)').fadeIn().addClass("ativo")}}});const UrlCepTurismo=urlName+'/racs/criar-turismo/cep';const UrlTurismo=urlName+'/racs/criar-turismo';const UrlCepServico=urlName+'/racs/criar-servico/cep';const UrlServico=urlName+'/racs/criar-servico';const LoadingAppCep=()=>document.getElementById('loadingAppCep').innerHTML='<div class="preloader-wrapper small active"><div class="spinner-layer spinner-blue-only"><div class="circle-clipper left"><div class="circle"></div></div><div class="gap-patch"><div class="circle"></div></div><div class="circle-clipper right"><div class="circle"></div></div></div></div>';const ParandoLoadingAppCep=()=>document.getElementById('loadingAppCep').innerHTML='';const LoadingApp=()=>document.getElementById('loadingApp').innerHTML='<div class="preloader-wrapper small active"><div class="spinner-layer spinner-blue-only"><div class="circle-clipper left"><div class="circle"></div></div><div class="gap-patch"><div class="circle"></div></div><div class="circle-clipper right"><div class="circle"></div></div></div></div>';const ParandoLoadingApp=()=>document.getElementById('loadingApp').innerHTML='';$('#cepAppTurismo').on('blur',function(event){if(document.querySelector("#cepAppTurismo").value.length==9){event.preventDefault();LoadingAppCep();var dados=$(this).serialize();$.ajax({url:getRoot(UrlCepTurismo),type:'post',dataType:'json',data:dados,success:function(response){if(response.retorno=='success'){inputsAddresSrv(response.inputs);ParandoLoadingAppCep()}else{M.toast({html:`<span class="lighten-2">${response.erros}</span><button class="btn-flat toast-action"><i class="material-icons yellow-text">error_outline</i></button>`,classes:'rounded',inDuration:5000,outDuration:5000,});ParandoLoadingAppCep()}}})}});$('#cepAppTurismo').on('focus',function(){var id=$(this).attr("id");if(id=="cepAppTurismo"){VMasker(document.querySelector("#cepAppTurismo")).maskPattern("99999-999")}});$("#formAppTurismo").on("submit",function(event){event.preventDefault();var form_img=new FormData(document.getElementById("formAppTurismo"));LoadingApp();$.ajax({url:getRoot(UrlTurismo),method:'post',data:form_img,dataType:'json',cache:!1,contentType:!1,processData:!1,success:function(response){$('.loading').empty();if(response.retorno=='erro'){getCaptcha();$.each(response.erros,function(key,value){M.toast({html:`<span class="lighten-2">${value}</span><button class="btn-flat toast-action"><i class="material-icons yellow-text">error_outline</i></button>`,classes:'rounded, red',inDuration:5000,outDuration:5000,})})}else{$.each(response.success,function(key,value){getCaptcha();M.toast({html:`<span>${value}</span><button class="btn-flat toast-action"><i class="material-icons blue-text">thumb_up</i></button>`,classes:'rounded, green',inDuration:5000,outDuration:5000,})});setTimeout(()=>{window.location.href=response.page},3000)}
ParandoLoadingApp()}})});$('#cepAppServico').on('blur',function(event){if(document.querySelector("#cepAppServico").value.length==9){event.preventDefault();LoadingAppCep();var dados=$(this).serialize();$.ajax({url:getRoot(UrlCepServico),type:'post',dataType:'json',data:dados,success:function(response){if(response.retorno=='success'){inputsAddresSrv(response.inputs);ParandoLoadingAppCep()}else{M.toast({html:`<span class="lighten-2">${response.erros}</span><button class="btn-flat toast-action"><i class="material-icons yellow-text">error_outline</i></button>`,classes:'rounded',inDuration:5000,outDuration:5000,});ParandoLoadingAppCep()}}})}});$('#cepAppServico').on('focus',function(){var id=$(this).attr("id");if(id=="cepAppServico"){VMasker(document.querySelector("#cepAppServico")).maskPattern("99999-999")}});$("#formAppServico").on("submit",function(event){event.preventDefault();var form_img=new FormData(document.getElementById("formAppServico"));LoadingApp();$.ajax({url:getRoot(UrlServico),method:'post',data:form_img,dataType:'json',cache:!1,contentType:!1,processData:!1,success:function(response){$('.loading').empty();if(response.retorno=='erro'){getCaptcha();$.each(response.erros,function(key,value){M.toast({html:`<span class="lighten-2">${value}</span><button class="btn-flat toast-action"><i class="material-icons yellow-text">error_outline</i></button>`,classes:'rounded, red',inDuration:5000,outDuration:5000,})})}else{$.each(response.success,function(key,value){getCaptcha();M.toast({html:`<span>${value}</span><button class="btn-flat toast-action"><i class="material-icons blue-text">thumb_up</i></button>`,classes:'rounded, green',inDuration:5000,outDuration:5000,})});setTimeout(()=>{window.location.href=response.page},3000)}
ParandoLoadingApp()}})})