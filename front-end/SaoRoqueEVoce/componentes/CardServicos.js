                ...
                <View style={estilos.conteudo1}>
                     <Text style={estilos.title}>{props.title}</Text>
                          <View style={{flex:1,justifyContent:'space-evenly', marginTop:5}}>
                              <Text style={{fontFamily:'Poppins-Regular',color:'#000',fontSize:14}}>{props.rua}</Text>
                                <View style={{flexDirection:'row',alignItems:'center'}}>
                                     <Image style={estilos.img} source={require('../images/servicos/funcionamento.png')}/>
                                     <Text style={estilos.txtConteudo}>{props.funcionamento}</Text>
                                 </View>
                                 <View style={{flexDirection:'row',alignItems:'center'}}>
                                     <Image style={estilos.img} source={require('../images/servicos/contato.png')}/>
                                     <Text style={estilos.txtConteudo}>{props.contato}</Text>
                                </View>                            
                         </View>
                 </View> 
             <View style={{flex:1,alignItems:'center', padding:15, justifyContent:'space-between'}}>  
                 <View>                      
                     <Text style={estilos.title}>{props.distancia} km</Text>
                     <TouchableOpacity>                     
                     <Image style={estilos.img} source={require('../images/servicos/rota.png')}/>
                     </TouchableOpacity>                     
                 </View>
...
const estilos = StyleSheet.create({
  container:{
    ...
    cardBody:{
        ...
        height: Dimensions.get('window').height-Dimensions.get('window').height*0.76,
        borderWidth:2,
        borderRadius:15,
        borderColor:'#910046',
        flexDirection:'row',
