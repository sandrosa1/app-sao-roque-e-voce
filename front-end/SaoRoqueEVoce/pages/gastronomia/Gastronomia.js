...
export default function App(){
  ...
  async function loadApi(){
    ...
    const response = await axios.post(`${url}/allapps/gastronomia?page=${page}`);
    ...
    useEffect(()=>{            
        setFiltro(dados.filter(item=>{if(item.segmento == 'gastronomia'){return true}}))
    },[dados]);
